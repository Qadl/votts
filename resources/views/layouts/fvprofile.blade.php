...
<head>
    ...
    <link href="{{ url('/css/vprof.css') }}" rel="stylesheet">
        ...
        <div class="row x-all">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center d-prv">
                    <img src="{{asset('uploads/images/'.$cprof->image)}}" width="100px" class='prvimg'>
                ...
                <div class="col-md-12 text-center x-zoom">
                    <button type="submit" class="btn x-sbt">
                        <a href="{{'/voting/' .$cprof->id}}" class="nav-link vt">VOTE</a></button>
                </div>

                <div class="col-md-12 text-center d-nam">

                    <div>
                        <h3 class="d-nh">{{$vtct}}</h3>
                        <p class="d-npp">votes</p>
                    </div>
                    <div>
                        <h3 class="d-nh">{{$cprof->user_id}}</h3>
